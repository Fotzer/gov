...
function Navbar(props) {
  ...
  return ( 
    <div className="navbar-content">
      ...
      <NavLink style={state => ({textDecoration: state.isActive ? "underline" : "none"})} className='navbar-link' to="/Survey"><h2 className='navbar-item navbar-region'>{props.language_ua ? "Опитування" : "Survey"}</h2></NavLink>
      <NavLink style={state => ({textDecoration: state.isActive ? "underline" : "none"})} className='navbar-link' to="/Languages"><h2 className='navbar-item navbar-region'>{props.language_ua ? "Мови" : "Languages"}</h2></NavLink>
